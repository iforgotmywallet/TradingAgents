#!/usr/bin/env python3
"""
Fix all recommendation inconsistencies using the improved extraction logic.
"""
...
def main():
    """Fix all recommendation inconsistencies."""
    try:
        print("🔧 Fixing all recommendation inconsistencies...")
                ...
                for session in sessions:
                    ...
                    if final_analysis:
                        ...
                        if current_recommendation != correct_recommendation:
                            ...
                            print(f"✅ {session_id}: {current_recommendation} (already consistent)")
                
                conn.commit()
                print(f"\\n✅ Updated {updates_made} sessions for consistency")
                
        finally:
            if conn:
                config.return_connection(conn)
        
        print("🎉 All recommendation inconsistencies fixed!")
